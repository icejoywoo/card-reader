...
-1：失败
***********************************************************************/
SMARTCOM_API int GetOneTCPCommunicator(Communicator& aCommunicator,const char* dstIP,int port,
									   int waitForSTX2Time=500,int normalWaitTime=500);
...
通过宏 取得具体定义
                                                               */
/************************************************************************/
SMARTCOM_API int CardApduK(Communicator& comm,const char* apdu,SmartCom::string& retCode,int card=1,int macNo=255);
...
-4: 发送失败
                                                               */
/************************************************************************/
SMARTCOM_API int  ExcuteMulAPDU(Communicator& comm,int cmdNum=0,int card=1,int macNo=255);
...
-5:文件打开失败
                                                           */
/************************************************************************/
SMARTCOM_API int DownloadScript(Communicator& comm,const char* fileName,int macNo=255);
...
-7:下载驱动未安装
                                                           */
/************************************************************************/
SMARTCOM_API int DownloadFileK(Communicator& comm,int flag,const char* fileName,int macNo=255);
...
-5:文件打开失败
                                                           */
/************************************************************************/
SMARTCOM_API int DownloadBin(Communicator& comm,int flag,const char* bin,unsigned int len,int macNo=255);
...
/************************************************************************/
SMARTCOM_API int EnableAutoAnswer(Communicator& comm,int macNo=255);
...
/************************************************************************/
SMARTCOM_API int DisableAutoAnswer(Communicator& comm,int macNo=255);
...
*/
/************************************************************************/
SMARTCOM_API int  ExcuteMulAPDUSyn(Communicator& comm,int cmdNum=0,int card=1,int macNo=255);
...
/************************************************************************/
SMARTCOM_API int SetSendInterval(Communicator& comm,BYTE interval,int macNo=255);
...
*句柄
**************************************************************************/
SMARTCOM_API HANDLE GetCOMHandle(int comport);
...
-1：失败
****************************************************************************/
int ReleaseCOMCommunicator(Communicator* pcomm);
...
-1：失败
****************************************************************************/
int ReleaseUDPCommunicator(Communicator* pcomm);
...
-1：失败
****************************************************************************/
int ReleaseTCPCommunicator(Communicator* p);
